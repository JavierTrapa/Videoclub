...
public class PeliPrueba extends javax.swing.JFrame {
    ...
    HashMap <String,PeliculasBBDD> listaPokemons = new HashMap();
    ...
    private void escribeDatos(){
        PeliculasBBDD p = listaPokemons.get(String.valueOf(contador+1));
        if (p != null){
            /*
    ...
    public PeliPrueba() {
        initComponents();
        try {
            imagenPokemons = ImageIO.read(getClass().getResource("ImagesPeliculas/000001.jpg"));
